...
function ScreenshotPlaceholder({ src, alt, className = "" }) {
  ...
  if (failed) {
    return (
      <div className={`rounded-xl bg-gradient-to-br from-sky-100 via-violet-100 to-emerald-100 flex items-center justify-center ${className}`}>
...
function FaqItem({ q, a }) {
  ...
  return (
    <div className="border-b border-slate-200 last:border-0">
      ...
      >
        <span className="text-base font-semibold text-slate-900 pr-4 group-hover:text-sky-600 transition-colors">{q}</span>
    ...
    <>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-center">
            {metrics.map((m, i) => (
              ...
              >
                ...
                <p className="mt-2 text-sm font-semibold text-sky-300">{m.label}</p>
            ...
            {showcaseFeatures.map((f, i) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-sky-100 text-sky-600 mb-4">
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900">
              And <span className="text-sky-500">more</span>
            </h2>
          </Motion.div>
        ...
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-3">
              Integrates with your <span className="text-sky-500">existing stack</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white border-t border-slate-100">
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900">
              Built with <span className="text-sky-500">security</span> in mind
            </h2>
            <p className="mt-3 text-lg text-slate-600">
