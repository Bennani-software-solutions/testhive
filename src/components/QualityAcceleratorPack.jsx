        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_.9fr]">
          ...
          >
            ...
            <ul className="mt-4 grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
              ...
              <li className="flex items-start gap-2">
                <GitBranch className="mt-0.5 h-5 w-5 text-indigo-600" /> Full CI/CD wiring
              </li>
              <li className="flex items-start gap-2">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 px-5 py-2 text-sm font-semibold text-white shadow-md transition active:scale-95"
