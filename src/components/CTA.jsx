...
export default function CTA({ onBook, calendlyUrl }) {
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-cyan-50 via-white to-violet-50 border-t border-gray-200">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-5">
          <button onClick={onBook} className="inline-flex items-center rounded-xl bg-gradient-to-r from-cyan-400 to-violet-500 px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:brightness-110 active:scale-95">
